...
$servername = "chiendaoo.database.windows.net";
$username = "chiendaoo";
$password = "123456a@";
$dbname = "clound";
  ...
  <div>
      ...
      <div id="listForm" class="form-container active">
        <table class="table text-center w-100">
          ...
          <tr style="vertical-align: middle;">
              ...
              <td><img src="<?php echo htmlspecialchars($row['img']) ?>" width="70px" height="80px"></td>
      ...
      <div id="addForm" class="form-container p-3">
        <form method="post" enctype="multipart/form-data">
          ...
          <input class="btn-input" type="submit" value="Thêm" />
        </form>
      </div>
  </div>
</div>
...
document.getElementById('showListBtn').onclick = function() {
    document.getElementById('listForm').classList.add('active');
...
document.getElementById('showAddBtn').onclick = function() {
    ...
    document.getElementById('listForm').classList.remove('active');
};
</script>
